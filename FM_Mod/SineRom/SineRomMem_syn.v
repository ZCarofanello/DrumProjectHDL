...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone V" ENABLE_RUNTIME_MOD="NO" INIT_FILE="SineWave.mif" NUMWORDS_A=4096 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" WIDTH_A=16 WIDTH_BYTEENA_A=1 WIDTHAD_A=12 address_a clock0 q_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_1.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_2.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_3.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_4.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_5.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_6.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_7.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_8.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_9.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_10.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_11.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_12.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_13.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_14.init_file = "SineWave.mif",
	...
	defparam
		...
		ram_block1a_15.init_file = "SineWave.mif",
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: MGL_INTERNAL_WARNING: (Depth description in MIF file is of illegal syntax.  Invalid depth description -- DEPTH=4096 -- found in file SineWave.mif)  ");
		$display("Warning: Memory initialization file SineWave.mif is not found. This may result in inconsistent simulation results.");
	end
endmodule //SineRomMem_altsyncram
//VALID FILE
...
`endif
	...
	SineRomMem_altsyncram	SineRomMem_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
